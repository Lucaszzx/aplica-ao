...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $categoriasCurso->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $categoriasCurso->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="categoriasCursos form content">
            ...
            <fieldset>
                <legend><?= __('Edit Categorias Curso') ?></legend>
                <?php
